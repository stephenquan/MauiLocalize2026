...
public static class LocalizationExtensions
{
	...
	/// <typeparam name="TReturn">The return type of the localized resource.</typeparam>
	...
	/// <param name="localizationProvider">A function that provides the localized string based on the current culture.</param>
	...
	public static T TranslateT<T, TReturn>(this T bindable, BindableProperty targetProperty, Func<CultureInfo?, TReturn> localizationProvider, params object?[] args) where T : BindableObject
	{
	...
	/// <param name="args">Optional arguments for string formatting.</param>
	/// <returns>The bindable object with the localized binding set.</returns>
	public static T Translate<T>(this T bindable, BindableProperty targetProperty, Func<CultureInfo?, string> localizationProvider, params object?[] args) where T : BindableObject
	{
		var binding = TranslateBindingBase.Create(localizationProvider, args);
		bindable.SetBinding(targetProperty, binding);
		return bindable;
	...
	/// <param name="args">Optional arguments for string formatting.</param>
	/// <returns>The bindable object with the localized binding set.</returns>
	public static T Translate<T>(this T bindable, BindableProperty targetProperty, Func<CultureInfo?, CultureInfo?, object?[], string?> localizationProvider, params object?[] args) where T : BindableObject
	{
		var binding = TranslateBindingBase.CreateT(localizationProvider, args);
		bindable.SetBinding(targetProperty, binding);
		return bindable;
	}
}
